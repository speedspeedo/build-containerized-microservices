...
func (w *watermarkService) Get(_ context.Context, fiilters ...internal.Filter) ([]internal.Document, error) {
...
func (w *watermarkService) Status(_ context.Context, ticketID string) (internal.Status, error) {
	...
	// return err if the ticketID is invalid ro no Document exists for that ticketID
